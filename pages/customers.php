...
while($row = $query->fetch_assoc()){
  ?>
    <tr>
      ...
      <td class="cl">
        <a onclick="return confirm('Are You Sure?')" href="customers.php?idd=<?php echo $row['id']?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
      </td>
    </tr>
  <?php
  }
  if(isset($_GET['idd'])){
    ...
    if($result){
      ...
      <script>
        ...
        window.location.href='http://localhost/www.ctc.com/pages/admin.php?p=customers';
      </script>
      <?php
    }else{
      ?>
